  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="my-8 md:my-16 px-4 md:px-0">
        <h2 className="text-3xl md:text-4xl font-serif text-center mb-3 md:mb-4">Our Offerings</h2>
        <p className="text-center text-gray-500 max-w-2xl mx-auto mb-6 md:mb-10 text-sm md:text-base px-4">
      ...
      <div className="layout">
        ...
        <div>
        <h1 className="text-xl mb-4 font-serif">Custom-branded gifts that connect with your audience.</h1>
