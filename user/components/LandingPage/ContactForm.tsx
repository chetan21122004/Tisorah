...
const ContactForm = () => {
  ...
  return (
    <section className="py-16 md:py-24 px-4 relative overflow-hidden bg-gradient-to-b from-white to-[#F4F4F4]/30">
      {/* Decorative Elements */}
      <motion.div
      ...
      <div className="max-w-6xl mx-auto relative">
        ...
        >
          <motion.div className="flex items-center justify-center gap-2 mb-4" variants={fadeInUp}>
            ...
            <span className="text-sm uppercase tracking-wider text-[#AD9660] font-medium">Get Your Custom Quote</span>
            <div className="w-12 h-[1px] bg-[#AD9660]"></div>
          </motion.div>
        ...
        <div className="grid md:grid-cols-5 gap-8">
          ...
          <motion.div
            className="md:col-span-3 bg-white rounded-2xl shadow-[0_0_50px_0_rgba(0,0,0,0.1)] p-8 md:p-12"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.7 }}
          >
            <h3 className="text-2xl font-['Frank_Ruhl_Libre'] font-light mb-6 text-[#323433]">Request Your Free Quote</h3>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              >
                {inputFields.map((field, index) => (
                  <motion.div 
                    ...
                    custom={index}
                  >
                    <label htmlFor={field.name} className="text-sm font-medium text-[#323433]/70 flex items-center gap-1">
                      {field.label}
              ...
              >
                <Button
                  type="submit"
                  className="bg-[#AD9660] hover:bg-[#8d7c50] text-white px-12 py-6 rounded-md text-lg font-medium tracking-wide transition-all duration-300 flex items-center gap-2 group shadow-lg hover:shadow-xl w-full md:w-auto"
                >
          ...
          >
            <div className="bg-[#F0EBE1] rounded-2xl p-8 shadow-lg">
              <h3 className="text-xl font-['Frank_Ruhl_Libre'] font-light mb-6 text-[#323433]">Why Choose Tisorah?</h3>
              
              <div className="space-y-5">
                <BenefitItem 
                  icon={<CheckCircle2 className="w-5 h-5 text-[#AD9660]" />}
                  title="Premium Quality"
                  description="Handpicked products that reflect your brand's prestige"
                />
                <BenefitItem 
                  icon={<ShieldCheck className="w-5 h-5 text-[#AD9660]" />}
            ...
            <div className="bg-[#323433] text-white rounded-2xl p-8 shadow-lg">
              <h3 className="text-xl font-['Frank_Ruhl_Libre'] font-light mb-4">Client Testimonial</h3>
              ...
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 rounded-full bg-[#AD9660]/20 flex items-center justify-center text-[#AD9660]">AB</div>
                <div>
                  <p className="font-medium">Abhishek Mehta</p>
                  <p className="text-sm text-white/60">HR Director, Tech Solutions Ltd</p>
                </div>
              </div>
            </div>
            ...
            <div className="relative h-48 rounded-2xl overflow-hidden shadow-lg">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex items-end p-6">
                <div>
                  <p className="text-white text-lg font-light">Browse Our</p>
                  <p className="text-white text-xl font-medium">Premium Collections</p>
                </div>
              </div>
            </div>
          </motion.div>
        ...
        >
          <div className="flex flex-col items-center">
            <div className="w-12 h-12 rounded-full bg-[#F0EBE1] flex items-center justify-center mb-4">
              <Phone className="w-5 h-5 text-[#AD9660]" />
            </div>
            <h4 className="text-lg font-medium mb-1">Call Us</h4>
            <p className="text-gray-600">+91 80888 48484</p>
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="text-gray-600">info@tisorah.com</p>
            <p className="text-gray-600">24/7 Support</p>
          </div>
          
          <div className="flex flex-col items-center">
            <div className="w-12 h-12 rounded-full bg-[#F0EBE1] flex items-center justify-center mb-4">
              <Building2 className="w-5 h-5 text-[#AD9660]" />
            </div>
            <h4 className="text-lg font-medium mb-1">Visit Us</h4>
            <p className="text-gray-600">12/14, Laxmi Narayan Nagar</p>
            <p className="text-gray-600">Erandwane, Pune - 411004</p>
          </div>
        </motion.div>
      </div>
    </section>
...
const BenefitItem: React.FC<BenefitItemProps> = ({ icon, title, description }) => {
  return (
    <div className="flex gap-4">
      ...
      <div>
        <h4 className="font-medium text-[#323433]">{title}</h4>
