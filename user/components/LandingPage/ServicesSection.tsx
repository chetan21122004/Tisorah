    ...
    <section className="relative bg-white overflow-hidden py-6 ">
      ...
      <div className="container mx-auto px-4 relative">
        ...
        >
          ...
          <h2 className="text-2xl md:text-4xl lg:text-5xl font-['Frank_Ruhl_Libre'] font-light text-[#323433] mb-3 md:mb-4">
        ...
        >
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 md:gap-8">
            <div className="md:w-2/3">
              <h3 className="text-xl md:text-3xl font-['Frank_Ruhl_Libre'] font-light text-[#323433] mb-2 md:mb-3">
